...
def get_config():
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help="Number of torch threads for training 训练过程抽出的环境数（线程数）2",
    )
    parser.add_argument(
        "--n_rollout_threads",
        type=int,
        default=5,
        help="Number of parallel envs for training rollouts 用于训练的并行环境数2",
    )
    parser.add_argument(
        "--n_eval_rollout_threads",
        type=int,
        default=2,
        help="Number of parallel envs for evaluating rollouts 2",
    )
    parser.add_argument(
